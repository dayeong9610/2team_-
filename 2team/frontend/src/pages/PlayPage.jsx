...
export default function PlayPage() {
    ...
    // 현재 Stage
    const currentStage = episode01Stages[stageIndex];
    // =========================
    // 사용자 답변
    // =========================
    ...
    return (<main className="game-page">
      ...
      <ProgressBar currentStage={currentStage.id} totalStages={episode01Stages.length}/>
      ...
      <section className="conversation">
        ...
        {currentStage.messages.map((message, index) => (<NPCBubble key={index} message={message}/>))}
      ...
      {answered && (<section className="result-area">

          <FeedbackCard userAnswer={userAnswer} scoreType={currentStage.scoreType}/>
